...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: '#333', marginBottom: 8 },
  input: {
  ...
  pickerButtonText: { fontSize: 16, color: '#333', fontFamily: 'Poppins_500Medium' },
  ...
  pickerDoneText: { color: '#fff', fontSize: 16, fontFamily: 'Poppins_600SemiBold' },
  ...
  colorCheckmark: { fontSize: 24, color: '#fff', fontFamily: 'Poppins_700Bold' },
  ...
  cancelButtonText: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: '#64748B' },
  submitButton: { backgroundColor: '#3B82F6' },
  submitButtonText: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: '#fff' },
  deleteButton: { backgroundColor: '#FEE2E2', marginTop: 0 },
  deleteButtonText: { fontSize: 16, fontFamily: 'Poppins_600SemiBold', color: '#EF4444' },
  ...
  calChipText: {
    fontSize: 14, fontFamily: 'Poppins_500Medium', color: '#1E293B'
  }
});
