...
export const SettingsScreen: React.FC = React.memo(() => {
  ...
  const getThemeLabel = () => {
    if (themeMode === 'minimal') return 'Minimalist B&W';
    if (themeMode === 'sage') return 'Sage (Balance)';
    if (themeMode === 'sunset') return 'Sunset (Warm)';
    if (themeMode === 'ocean') return 'Ocean (Calm)';
          ...
          <View style={styles.card}>
            <TouchableOpacity style={styles.settingButton} onPress={() => navigation.navigate('Paywall')}>
              ...
              <View style={{ backgroundColor: '#EFF6FF', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12, marginRight: 8 }}>
                <Text style={{ color: '#3B82F6', fontSize: 12, fontWeight: '700' }}>PRO</Text>
              </View>
              <Text style={styles.settingButtonIcon}>›</Text>
            </TouchableOpacity>
          </View>
      ...
      <Modal visible={showThemeModal} animationType="slide" transparent={true} onRequestClose={() => setShowThemeModal(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity style={styles.modalField} onPress={() => { setThemeMode('system'); setShowThemeModal(false); }}>
              <Text style={{ fontSize: 16, padding: 10, color: themeMode === 'system' ? '#3B82F6' : '#000' }}>System Default</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalField} onPress={() => { setThemeMode('sage'); setShowThemeModal(false); }}>
              <Text style={{ fontSize: 16, padding: 10, color: themeMode === 'sage' ? '#3B82F6' : '#000' }}>Sage (Balance)</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalField} onPress={() => { setThemeMode('minimal'); setShowThemeModal(false); }}>
              <Text style={{ fontSize: 16, padding: 10, color: themeMode === 'minimal' ? '#3B82F6' : '#000' }}>Minimalist B&W</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalField} onPress={() => { setThemeMode('sunset'); setShowThemeModal(false); }}>
              <Text style={{ fontSize: 16, padding: 10, color: themeMode === 'sunset' ? '#3B82F6' : '#000' }}>Sunset (Warm)</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalField} onPress={() => { setThemeMode('ocean'); setShowThemeModal(false); }}>
              <Text style={{ fontSize: 16, padding: 10, color: themeMode === 'ocean' ? '#3B82F6' : '#000' }}>Ocean (Calm)</Text>
            </TouchableOpacity>
            <View style={styles.modalButtons}>
...
const styles = StyleSheet.create({
  ...
  profileName: { fontSize: 20, fontWeight: '700', color: '#333', marginBottom: 4 },
  ...
  modalButtonTextCancel: { fontSize: 16, fontWeight: '600', color: '#666' },
